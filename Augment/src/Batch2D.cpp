...
indexBuff(glGenBuffer())
{
	...
	shaderProgram.LoadShader(R"(C:\git\Augment\res\shader\Batch2D.vert)", GL_VERTEX_SHADER);
	shaderProgram.LoadShader(R"(C:\git\Augment\res\shader\Batch2D.frag)", GL_FRAGMENT_SHADER);
	shaderProgram.Link();
